...
public class Printer implements OutputCompleteListener, StatusUpdateListener, ErrorListener {
...
//				printer.checkHealth(JposConst.JPOS_CH_INTERACTIVE);
				...
				printer.printNormal(POSPrinterConst.PTR_S_RECEIPT, "   1  830    Bram had gelijk : YES" + LF);
